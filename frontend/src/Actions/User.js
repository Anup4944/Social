...
export const loginAction = (email, password) => async (dispatch) => {
  try {
    ...
    dispatch({ type: "LoginFailure", payload: getErrMsg(error) });
  }
};
...
export const loadUserAction = () => async (dispatch) => {
  try {
    ...
    dispatch({ type: "LoadUserFailure", payload: getErrMsg(error) });
  }
};
...
export const getFollowingPostAction = () => async (dispatch) => {
  try {
    ...
    dispatch({ type: "postOfFollowingFailure", payload: getErrMsg(error) });
  }
};
...
export const getAllUsersAction =
  ...
  async (dispatch) => {
    try {
      ...
      dispatch({ type: "allUsersFailure", payload: getErrMsg(error) });
    }
  };
...
export const logoutUserAction = () => async (dispatch) => {
  try {
    ...
    dispatch({ type: "logoutUserFailure", payload: getErrMsg(error) });
  }
};
...
export const registerUserAction =
  (name, email, avatar, password) => async (dispatch) => {
    try {
      ...
      dispatch({ type: "RegisterFailure", payload: getErrMsg(error) });
    }
  };
...
export const updateProfileAction =
  (name, email, avatar) => async (dispatch) => {
    try {
      ...
      dispatch({ type: "updateProfileFailure", payload: getErrMsg(error) });
    }
  };
...
export const updatePasswordAction =
  (oldPassword, newPassword) => async (dispatch) => {
    try {
      ...
      dispatch({ type: "updatePasswordFailure", payload: getErrMsg(error) });
    }
  };
...
export const deleteProfileAction = () => async (dispatch) => {
  try {
    ...
    dispatch({ type: "deleteProfileFailure", payload: getErrMsg(error) });
  }
};
...
export const forgotPasswordAction = (email) => async (dispatch) => {
  try {
    ...
    dispatch({ type: "forgotPasswordFailure", payload: getErrMsg(error) });
  }
};
...
export const resetPasswordAction = (token, password) => async (dispatch) => {
  try {
    ...
    dispatch({ type: "resetPasswordFailure", payload: getErrMsg(error) });
  }
};
...
export const getMyPostAction = () => async (dispatch) => {
  try {
    ...
    dispatch({ type: "myPostsFailure", payload: getErrMsg(error) });
  }
};
...
export const getUserPostAction = (id) => async (dispatch) => {
  try {
    ...
    dispatch({ type: "userPostsFailure", payload: getErrMsg(error) });
  }
};
...
export const getUserProfileAction = (id) => async (dispatch) => {
  try {
    ...
    dispatch({ type: "userProfileFailure", payload: getErrMsg(error) });
  }
};
...
export const followAndUnfollowAction = (id) => async (dispatch) => {
  try {
    ...
    dispatch({ type: "followUserFailure", payload: getErrMsg(error) });
  }
};
